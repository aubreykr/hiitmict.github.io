...
# read in wearables dataframes
wearables<-read.csv("/Users/aubreykr/Desktop/wearable_data.csv")
#wearables$record_id<-as.factor(wearables$record_id)
...
write.csv(demog, "/Users/aubreykr/Desktop/fellowship_demog.csv")
```
...
```{r testdata, echo=FALSE, include=FALSE}
